...
public class MenuController {
    ...
    @Operation(summary = "Получает список блюд доступных в меню")
    @GetMapping
    ...
    @Operation(summary = "Добавляет блюдо в меню [ADMIN]")
    @PostMapping
    ...
    @Operation(summary = "Меняет указанное блюдо в меню [ADMIN]")
    @PutMapping
